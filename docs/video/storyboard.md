...
| **2** | 1050–1230 *(6 s: el beneficio central)* | **Mensajes automáticos, en el momento justo** + subtítulo *"Un sistema de IA te sugiere qué enviar. Vos aprobás y sale solo."* | **1050–1100:** tarjeta **"Sugerencia del sistema de IA"** con cuenta regresiva: **"Faltan 5 días para que Juli cumpla años"** (y debajo: Martín en 2 días · Caro en 4 · Lucas en 6), con el **mensaje sugerido de invitación** (*"…queremos festejarlo con vos. Vení cuando quieras esta semana: el postre corre por nuestra cuenta. ¿Te reservamos una mesa?"*) y el botón **Aprobar y enviar a los 4** (anillo menta dibujándose alrededor) → hover y clic. **1100–1150:** el mensaje se **reparte solo**: cuatro líneas curvas salen del botón hacia cuatro avatares (Juli, Martín, Caro, Lucas) que reciben un check, escalonados cada 5 cuadros; contador *"Enviado automáticamente a 4 clientes"*. **1150–1185:** un teléfono chico entra desde abajo con la burbuja de la invitación (*"¡Hola, Juli! Faltan pocos días para tu cumple… el postre corre por nuestra cuenta. ¿Te reservamos una mesa?"*) y la etiqueta "automático". **1185–1230:** pantalla **Mensajes automáticos** del panel: cuatro interruptores se encienden en cascada (*Bienvenida · Saludo de cumpleaños · Aviso de premio disponible · "Te extrañamos"*) y encima entra **"Vos decidís qué se envía. El sistema lo hace solo."** |
