          ...
          {line.map((w0, wi) => {
            ...
            return (
              <span key={wi} style={{ position: "relative", display: "inline-block", overflow: "visible" }}>
                {w.hl && (
                  <span style={{ position: "absolute", left: -size * 0.17, right: -size * 0.17, top: size * 0.05, bottom: -size * 0.01, background: pal.hlBg, borderRadius: size * 0.12, transform: `scaleX(${paint})`, transformOrigin: "left center", overflow: "hidden" }}>
