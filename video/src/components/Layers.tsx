  ...
  return (
    <AbsoluteFill
      style={{
        ...
        // grano FIJO: si cambia cuadro a cuadro, el compresor de video (y el de Instagram)
        // reparte mal la calidad y el texto fino tiembla y lo que se desplaza se traba.
