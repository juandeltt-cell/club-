  ...
  suggestions: [
    {
      ...
      message: "¡Hola, {nombre}! Se viene tu cumple y en Brasa Restó queremos festejarlo con vos: si venís con 4 amigos, tu plato va por nuestra cuenta. ¿Te reservamos mesa?",
      previewFor: "Juli",
    ...
    },
    {
      ...
      why: "Venían al menos dos veces por mes. Una invitación con un café de regalo es la mejor forma de traerlos de vuelta.",
      message: "¡Hola, {nombre}! Hace un tiempo que no te vemos por Brasa Restó y te extrañamos. Te esperamos esta semana: el café corre por nuestra cuenta.",
      previewFor: "Tomás",
    ...
    },
    {
      ...
      kind: "slow",
      icon: "trend",
      title: "Los martes vienen la mitad de clientes que el resto de la semana",
      why: "Una promo fija para ese día, avisada a tus frecuentes, ayuda a mover el día más flojo sin descontar los demás.",
      message: "¡Novedad en Brasa Restó! Los martes, cada visita suma 2 estrellitas. ¿Nos vemos el martes, {nombre}?",
      previewFor: "Nicolás",
      audience: ["nico", "mora", "ramiro", "santi"],
      audienceLabel: "148 clientes frecuentes",
      cta: "Activar martes de doble estrellita",
      boostsWeekday: "mar",
    },
    {
      id: "reward",
  ...
  automations: [
    {
      ...
      message: "¡Bienvenida a Mejores Amigos, {nombre}! Sumaste tu 1.ª estrellita en Brasa Restó. Con 5 desbloqueás tu primer premio.",
    ...
    },
    {
      ...
      message: "¡{nombre}, desbloqueaste tu primer premio! Con tu próximo plato, el postre va sin cargo.",
